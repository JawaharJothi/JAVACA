...
<body>
	<form action="/team8/lecturerprocess" method="post">
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">
							<fmt:message key="label.lecturer.info" />
						</div>
						<div class="panel-body">
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group">
										<label><fmt:message key="setup.id" /></label>
									...
									<div class="form-group">
										<label><fmt:message key="setup.name" /></label> <input name="name"
									...
									<div class="form-group">
										<label><fmt:message key="setup.address" /></label>
										<textarea name="address" class="form-control" rows="3" >${param['address']}</textarea>
									</div>
									<div class="form-group">
										<label><fmt:message key="setup.email" /></label> <input name="email"
											class="form-control" type="text" value="${param['email']}" maxlength="45">
									</div>
									<div class="form-group">
										<label><fmt:message key="setup.edu" /></label> <input name="edu"
											class="form-control" type="text" value="${param['edu']}" maxlength="200">
									</div>
									<div class="form-group">
